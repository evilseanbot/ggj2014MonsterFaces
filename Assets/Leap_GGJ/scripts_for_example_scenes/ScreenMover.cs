...
public class ScreenMover : MonoBehaviour {
	...
	void Update () {
		if(_leapManager != null) { 
			...
			{
				Vector2 screenPos = _leapManager.pointerPositionScreen;
				this.transform.position = _mainCam.ScreenToWorldPoint(new Vector3(screenPos.x, screenPos.y, _projectionDistance)); 
